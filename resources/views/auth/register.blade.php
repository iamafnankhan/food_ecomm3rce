    ...
    <div id="page-content" class="page-content">
        <div class="banner">
            <div class="jumbotron jumbotron-bg text-center rounded-0"
                style="background-image: url('assests/img/bg-header.jpg'); background-size: cover; background-position: center; min-height: calc(100vh + 50px); margin: -25px; display: flex; align-items: center; justify-content: center;">
                <div class="container">
                    <h1 class="pt-5 white-text">
                        Register Page
                    </h1>
...
{{-- 
                                ...
                                {{-- <form method="POST" action="{{ route('register') }}"> --}}
                                    ...
                                    {{-- <div class="form-group row mt-3">
                                        <div class="col-md-12">
                                            <input placeholder="confirm_password" id="confirm_password" type="password"
                                    ...
                                    <div class="col-md-12">
                                        <div class="checkbox">
                                            ...
                                            <label for="checkbox0" class="mb-0">I Agree with <a href="terms.html"
                                                    class="text-light-black">Terms & Conditions</a> </label>
                                        </div>
                                    </div>
                                </div>
